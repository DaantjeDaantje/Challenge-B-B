...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 15 mrt 2022 om 09:14
...
INSERT INTO `cottages` (`cottage_id`, `cottage_name`, `cottage_excerpt`, `cottage_descr`, `cottage_img`, `cottage_img2`, `cottage_img3`, `cottage_img4`, `cottage_price_a`, `cottage_price_b`, `cottage_price_c`) VALUES
(1, 'IJmuiden cottage', 'Genieten van de duinen, het strand en de zee.', 'Een vakantie hier geeft je alle mogelijkheden, activiteiten gedurende de dag zoals surfen of wandelen in de duinen. In de avond lekker bijkomen van een actieve dag bij de open haard of in de hot tub.', 'ijmuiden.jpg', 'ijmuiden-strand.jpg', 'ijmuiden-hottub.jpg', 'ijmuiden-haard.jpg', 60, 0, 20),
(2, 'Assen bungalow', 'Midden in de bossen van Drente staat dit prachtige huis', 'Na een flinke boswandeling of een bezoek aan de hunebedden kun je na een frisse duik gezellig dineren bij het zwembad. Of je neemt een verfrissende douche in de buitenlucht. Ook een bezoek aan de stad is mogelijk. Een vakantie om nooit te vergeten!', 'assen.jpg', 'assen-bos.jpg', 'assen-douche.jpg', 'assen-zwembad.jpg', 60, 0, 15),
...
--
ALTER TABLE `cottages`
  MODIFY `cottage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `cottages_facilities`
  ...
  ADD CONSTRAINT `foreign key 2` FOREIGN KEY (`facility_id`) REFERENCES `facilities` (`facility_id`);
COMMIT;
